...
<body>
	...
	<div class="row ">
		...
		<a class="btn btn-outline-info btn-group-lg btn-block container" href="./../libros-administrador/registro-producto/alta_libro.html" role="button">Registrar un usuario</a>
